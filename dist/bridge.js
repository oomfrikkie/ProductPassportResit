...
function startBridge(mqttClient, pg, maria) {
    ...
    mqttClient.on("message", async (topic, msgBuffer) => {
        ...
        try {
            await pg.query("INSERT INTO product_events (event_data) VALUES ($1)", [msg]);
        ...
        // Insert into MariaDB
        try {
            await maria.query("INSERT INTO events (payload) VALUES (?)", [msg]);
